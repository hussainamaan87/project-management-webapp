...
import {LockIcon, LucideIcon,Home,X, Briefcase, Search, Settings, Users, User, ChevronUp, ChevronDown, AlertCircle, ShieldAlert, AlertTriangle, AlertOctagon, Layers3} from "lucide-react"
...
const Sidebar = () => {
  ...
  const sidebarClassName = `fixed flex flex-col h-[100%] justify-between 
    ...
    overflow-y-auto bg-white ${isSidebarCollapsed ? "w-0 hidden" : "w-64 overflow-hidden"}`
    ...
    <div className={sidebarClassName}>
      <div className='flex h-[100%] w-full flex-col justify-start'>
        ...
        <div className='flex items-center gap-5 border-y-[1.5px] border-gray-200 px-8 py-4 dark:border-gray-700'>
          <Image src="https://pm-s3-images-x.s3.ap-south-1.amazonaws.com/logo.png" alt="Logo" width={40} height = {40} />
          <div>
